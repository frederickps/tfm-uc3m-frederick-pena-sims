...
spending_CCAA_final <- 
  ...
  mutate(per_capita_CCAA = total/pop_2020,
         per_capita_ccaa_general_services = ccaa_general_services/pop_2020,
         per_capita_ccaa_security = ccaa_security/pop_2020,
         per_capita_ccaa_economic = ccaa_economic/pop_2020,
         per_capita_ccaa_housing_services = ccaa_housing_services/pop_2020, ccaa_health_per_capita = ccaa_health/pop_2020,
         per_capita_ccaa_culture = ccaa_culture/pop_2020,
         per_capita_ccaa_social_protection = ccaa_social_protection/pop_2020,
         share_ccaa_general_services = (ccaa_general_services/total)*100,
  ...
  select(CODAUTO, per_capita_CCAA, total_CCAA, per_capita_ccaa_general_services, per_capita_ccaa_security, per_capita_ccaa_economic, per_capita_ccaa_housing_services, per_capita_ccaa_culture, per_capita_ccaa_social_protection, share_ccaa_general_services, share_ccaa_security, share_ccaa_economic, share_ccaa_housing_services, share_ccaa_culture, share_ccaa_social_protection)
```

ccaa_general_services, ccaa_security, ccaa_economic, ccaa_housing_services, ccaa_health, ccaa_culture, ccaa_social_protection \## Contracts
...
df <- 
  ...
  mutate(per_capita_MUN = total_MUN/pop_total,
         ...
         revenue_tax_share = revenue_tax/total_revenue_MUN,
